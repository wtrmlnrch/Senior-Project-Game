...
@export var dialogic_timeline: String = "res://Dialogue stuff/GarrothTalk.dtl"
@export var speak: String = "res://Dialogue stuff/GarrothNight.dtl"
...
func interact():
	if player_in_range:
		...
		if current_scene == "garroth-house":
			Dialogic.start("res://Dialogue stuff/GarrothTalk.dtl")
